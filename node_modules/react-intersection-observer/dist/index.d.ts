 ...
 */
declare function observe(element: Element, callback: ObserverInstanceCallback, options?: IntersectionObserverInitWithOptions, fallbackInView?: boolean | undefined): () => void;
 ...
 * ```
 */
declare function useInView({ threshold, delay, trackVisibility, rootMargin, scrollMargin, root, triggerOnce, skip, initialInView, fallbackInView, onChange, }?: IntersectionOptions): InViewHookResponse;
 ...
 * ```
 */
declare const useOnInView: <TElement extends Element>(onIntersectionChange: IntersectionChangeEffect<TElement>, { threshold, root, rootMargin, scrollMargin, trackVisibility, delay, triggerOnce, skip, }?: IntersectionEffectOptions) => ((element: TElement | undefined | null) => (() => void) | undefined);

type Omit<T, K extends keyof T> = Pick<T, Exclude<keyof T, K>>;
type IntersectionObserverInitWithOptions = IntersectionObserverInit & {
...
interface IntersectionOptions extends IntersectionObserverInitWithOptions {
...
export { InView, type InViewHookResponse, type IntersectionChangeEffect, type IntersectionEffectOptions, type IntersectionObserverInitWithOptions, type IntersectionObserverProps, type IntersectionOptions, type ObserverInstanceCallback, type PlainChildrenProps, defaultFallbackInView, observe, useInView, useOnInView };
